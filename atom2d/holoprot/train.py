...
from datasets import HoloProtDataModule
from pl_module import HoloProtPLModule
...
def main(cfg=None):
    ...
    trainer = pl.Trainer(
        ...
        check_val_every_n_epoch=cfg.train.check_every,
    ...
    # datamodule
    datamodule = HoloProtDataModule(cfg)
